...
public class Registro {
    ...
    public static void reg_asesor(JTextField Codigo_Asesor, JTextField Nombre_Asesor,
        ...
        String sql = "insert into asesores(id_asesor, as_nombre, as_contrasenia, as_materia, as_correo, as_telefono) values (?,?,?,?,?,?)";
        Statement stmt;
        Coneccion conx = new Coneccion();
        Connection con = null;
        con = conx.conectar();
        ...
        try{
            ...
            ps.setString(5,Telefono_Asesor.getText());
            ps.setString(6,Correo_Asesor.getText());
            resultado = ps.executeUpdate();
            if(resultado == 1){
